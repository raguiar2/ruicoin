...
const char * const BITCOIN_CONF_FILENAME = "ruicoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "ruicoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/ruicoin";
#else
    // Unix
    return pathRet / ".ruicoin";
#endif
#endif
}
