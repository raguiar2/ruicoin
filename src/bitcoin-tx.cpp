...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ruicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ruicoin-tx [options] <hex-tx> [commands]  Update hex-encoded ruicoin transaction\n" +
            "or:     ruicoin-tx [options] -create [commands]   Create hex-encoded ruicoin transaction\n" +
            "\n";
