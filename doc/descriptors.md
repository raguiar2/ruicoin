# Support for Output Descriptors in RuiCoin Core

Since RuiCoin Core v0.17, there is support for Output Descriptors. This is a
...
on RuiCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing RuiCoin Core wallets, a convenience function `combo` is
