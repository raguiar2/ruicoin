...
"""Verify that starting ruicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ruicoin with -h for help text")
        ...
        self.log.info("Start ruicoin with -version for version information")
        ...
        self.log.info("Start ruicoind with -fakearg to make sure it does not start")
